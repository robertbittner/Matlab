function [bTransferSuccessful] = copyAnonymisedHighResAnatomyToServerATWM1(folderDefinition, parametersMriSession, parametersStructuralMriSequenceHighRes, aStrPathOriginalDicomFiles, aStrOriginalDicomFiles)

global strGroup
global strSubject

[folderDefinition] = defineArchiveFolderForAnonymisedDataATWM1(folderDefinition, parametersStructuralMriSequenceHighRes);
...
folderHighResAnatomyGroupServer = strcat(folderDefinition.anonymisedDataArchiveHighResAnatomyServer, strGroup, '\');
