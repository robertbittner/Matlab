...
parametersParadigm.nTrialsPerRun                = 120;
...
conditions = {'Nonsalient_Uncued_Run1';'Nonsalient_Uncued_Run2';'Salient_Uncued_Run1';'Salient_Uncued_Run2';...
    'Nonsalient_Cued_Run1';'Nonsalient_Cued_Run2'; 'Salient_Cued_Run1';'Salient_Cued_Run2';};

numconditions = length(conditions);

%create results files

resultsFilePath= strcat(logfiledir,'\','ATWM1_timing_results_behavior_MEG');
...
resultsFilePath2=strcat(logfiledir,'\','ATWM1_stats_timing_behavior_MEG');
...
for n=1:numsubs
    ...
    for c=1:numconditions
        ...
        % calculate stats
        percentage_wrong{n}=wrong_timing(n)/120;
