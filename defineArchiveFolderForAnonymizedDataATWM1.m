function [folderDefinition] = defineArchiveFolderForAnonymizedDataATWM1(folderDefinition, parametersStructuralMriSequenceHighRes)
...
strOld = folderDefinition.strAnonymizedDataArchiveHighResAnatomy;
